...
namespace FunctionApp.HttpTriggers
{
    public static class OpenIDConnectAuthFlowHttpTrigger
    {
        ...
        [OpenApiSecurity("oidc_auth", SecuritySchemeType.OpenIdConnect, OpenIdConnectUrl = "https://localhost:5001/.well-known/openid-configuration", OpenIdConnectScopes = "openid,profile")]
